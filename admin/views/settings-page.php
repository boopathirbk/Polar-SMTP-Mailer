...
$settings = PSM_Settings::get_settings();
$providers = PSM_Providers::get_providers();
$encryption_options = PSM_Providers::get_encryption_options();
?>
            ...
            <div class="ssm-card">
                ...
                <table class="form-table">
                    ...
                    <tr>
                        ...
                        <td><input type="text" name="PSM_smtp_host" id="PSM_smtp_host" value="<?php echo esc_attr( $settings['smtp_host'] ); ?>" class="regular-text" placeholder="smtp.example.com"></td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        ...
                        <td>
                            <label><input type="checkbox" name="PSM_smtp_auth" id="PSM_smtp_auth" value="1" <?php checked( $settings['smtp_auth'] ); ?>> <?php esc_html_e( 'Use SMTP authentication', 'polar-smtp-mailer' ); ?></label>
                        </td>
                    </tr>
                    <tr class="ssm-auth-field">
                        <th scope="row"><label for="PSM_smtp_username"><?php esc_html_e( 'Username', 'polar-smtp-mailer' ); ?></label></th>
                        <td><input type="text" name="PSM_smtp_username" id="PSM_smtp_username" value="<?php echo esc_attr( $settings['smtp_username'] ); ?>" class="regular-text" autocomplete="off" placeholder="user@example.com"></td>
                    </tr>
                    <tr class="ssm-auth-field">
                        <th scope="row"><label for="PSM_smtp_password"><?php esc_html_e( 'Password', 'polar-smtp-mailer' ); ?></label></th>
                        <td>
                            <input type="password" name="PSM_smtp_password" id="PSM_smtp_password" value="<?php echo esc_attr( $settings['smtp_password'] ); ?>" class="regular-text" autocomplete="new-password" placeholder="<?php esc_attr_e( 'Enter your SMTP password', 'polar-smtp-mailer' ); ?>">
            ...
            <div class="ssm-card">
                ...
                <table class="form-table">
                    <tr>
                        ...
                        <td>
                            <input type="email" name="PSM_from_email" id="PSM_from_email" value="<?php echo esc_attr( $settings['from_email'] ); ?>" class="regular-text" placeholder="you@example.com">
                            <label class="ssm-force-option"><input type="checkbox" name="PSM_force_from_email" value="1" <?php checked( $settings['force_from_email'] ); ?>> <?php esc_html_e( 'Force this email', 'polar-smtp-mailer' ); ?></label>
                    ...
                    <tr>
                        ...
                        <td>
                            <input type="text" name="PSM_from_name" id="PSM_from_name" value="<?php echo esc_attr( $settings['from_name'] ); ?>" class="regular-text" placeholder="<?php echo esc_attr( get_bloginfo( 'name' ) ); ?>">
                            <label class="ssm-force-option"><input type="checkbox" name="PSM_force_from_name" value="1" <?php checked( $settings['force_from_name'] ); ?>> <?php esc_html_e( 'Force this name', 'polar-smtp-mailer' ); ?></label>
                        </td>
                    </tr>
                </table>
            </div>
            ...
            <div class="ssm-card">
                ...
                <table class="form-table">
                    <tr>
                        ...
                        <td><label><input type="checkbox" name="PSM_enable_logging" value="1" <?php checked( $settings['enable_logging'] ); ?>> <?php esc_html_e( 'Log all outgoing emails', 'polar-smtp-mailer' ); ?></label></td>
                    </tr>
                    <tr>
                        <th scope="row"><label for="PSM_log_retention_days"><?php esc_html_e( 'Log Retention', 'polar-smtp-mailer' ); ?></label></th>
                        <td>
                            <input type="number" name="PSM_log_retention_days" id="PSM_log_retention_days" value="<?php echo esc_attr( $settings['log_retention_days'] ); ?>" class="small-text" min="0"> <?php esc_html_e( 'days', 'polar-smtp-mailer' ); ?>
            ...
            <div class="ssm-card">
                ...
                <table class="form-table">
                    <tr>
                        ...
                        <td>
                            <label><input type="checkbox" name="PSM_enable_queue" value="1" <?php checked( $settings['enable_queue'] ); ?>> <?php esc_html_e( 'Queue emails for scheduled sending', 'polar-smtp-mailer' ); ?></label>
                    ...
                    <tr class="ssm-queue-field">
                        ...
                        <td><input type="number" name="PSM_queue_batch_size" id="PSM_queue_batch_size" value="<?php echo esc_attr( $settings['queue_batch_size'] ); ?>" class="small-text" min="1" max="100"> <?php esc_html_e( 'emails per batch', 'polar-smtp-mailer' ); ?></td>
                    </tr>
                    <tr class="ssm-queue-field">
                        <th scope="row"><label for="PSM_queue_interval"><?php esc_html_e( 'Processing Interval', 'polar-smtp-mailer' ); ?></label></th>
                        <td><input type="number" name="PSM_queue_interval" id="PSM_queue_interval" value="<?php echo esc_attr( $settings['queue_interval'] ); ?>" class="small-text" min="1" max="60"> <?php esc_html_e( 'minutes', 'polar-smtp-mailer' ); ?></td>
                    </tr>
                </table>
            </div>
            ...
            <div class="ssm-card">
                ...
                <table class="form-table">
                    <tr>
                        ...
                        <td>
                            <label><input type="checkbox" name="PSM_enable_backup_smtp" id="PSM_enable_backup_smtp" value="1" <?php checked( $settings['enable_backup_smtp'] ); ?>> <?php esc_html_e( 'Use backup SMTP when primary fails', 'polar-smtp-mailer' ); ?></label>
                        </td>
                    </tr>
                    ...
                    <tr class="ssm-backup-field">
                        ...
                        <td><input type="text" name="PSM_backup_smtp_host" id="PSM_backup_smtp_host" value="<?php echo esc_attr( $settings['backup_smtp_host'] ); ?>" class="regular-text" placeholder="smtp.backup-provider.com"></td>
                    </tr>
                    <tr class="ssm-backup-field">
                    ...
                    <tr class="ssm-backup-field">
                        ...
                        <td><input type="text" name="PSM_backup_smtp_username" id="PSM_backup_smtp_username" value="<?php echo esc_attr( $settings['backup_smtp_username'] ); ?>" class="regular-text" placeholder="user@example.com"></td>
                    </tr>
                    <tr class="ssm-backup-field">
                        <th scope="row"><label for="PSM_backup_smtp_password"><?php esc_html_e( 'Password', 'polar-smtp-mailer' ); ?></label></th>
                        <td>
                            <input type="password" name="PSM_backup_smtp_password" id="PSM_backup_smtp_password" value="<?php echo esc_attr( $settings['backup_smtp_password'] ); ?>" class="regular-text" placeholder="<?php esc_attr_e( 'Enter your SMTP password', 'polar-smtp-mailer' ); ?>">
                            <button type="button" class="button ssm-toggle-password" aria-label="<?php esc_attr_e( 'Show password', 'polar-smtp-mailer' ); ?>"><span class="dashicons dashicons-visibility"></span></button>
                            <p class="description"><?php esc_html_e( 'Password is encrypted before storage.', 'polar-smtp-mailer' ); ?></p>
                        </td>
                    </tr>
            ...
            <div class="ssm-card">
                ...
                <table class="form-table">
                    <tr>
                        ...
                        <td>
                            <label><input type="checkbox" name="PSM_debug_mode" value="1" <?php checked( $settings['debug_mode'] ); ?>> <?php esc_html_e( 'Enable debug logging', 'polar-smtp-mailer' ); ?></label>
            ...
            <div class="ssm-card">
                ...
                <table class="form-table">
                    <tr>
                        ...
                        <td>
                            <label><input type="checkbox" name="PSM_delete_data_on_uninstall" value="1" <?php checked( $settings['delete_data_on_uninstall'] ); ?>> <?php esc_html_e( 'Delete all plugin settings and logs on uninstall', 'polar-smtp-mailer' ); ?></label>
